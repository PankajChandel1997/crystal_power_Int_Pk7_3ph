...
namespace Infrastructure.DTOs.ThreePhaseEventDTOs
{
    public class BillingProfileThreePhaseDto
    {
        ...
        public string PowerFactorExport { get; set; }
        ...
        [DisplayName("MD kW Export")]
        public string MaximumDemandkWExport { get; set; }

        [DisplayName("MD kW Export DateTime")]
        public string MaximumDemandkWExportDateTime { get; set; }
        ...
        [DisplayName("MD kVA Export")]
        public string MaximumDemandkVAExport { get; set; }

        [DisplayName("MD kVA Export DateTime")]
        public string MaximumDemandkVAExportDateTime { get; set; }
